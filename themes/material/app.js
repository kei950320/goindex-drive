...
if(dark){document.write('<style>* {box-sizing: border-box}body{color:rgba(255,255,255,.87);background-color:#232427}.mdui-theme-primary-'+main_color+' .mdui-color-theme{background-color:#ea5808!important}</style>');}
